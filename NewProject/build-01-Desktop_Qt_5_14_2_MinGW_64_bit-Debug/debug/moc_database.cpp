...
QT_MOC_LITERAL(1, 9, 11), // "readingData"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 3), // "num"
QT_MOC_LITERAL(4, 26, 13), // "startReadData"
QT_MOC_LITERAL(5, 40, 5), // "total"
QT_MOC_LITERAL(6, 46, 3) // "msg"

    },
    "DataBase\0readingData\0\0num\0startReadData\0"
    "total\0msg"
};
...
void DataBase::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->readingData((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->startReadData((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< const QString(*)>(_a[2]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DataBase::readingData)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (DataBase::*)(int , const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DataBase::startReadData)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void DataBase::readingData(int _t1)
{
...
// SIGNAL 1
void DataBase::startReadData(int _t1, const QString & _t2)
{
