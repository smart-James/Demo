...
void HelpWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&HelpWidget::mySignal)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (HelpWidget::*)(int , QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&HelpWidget::mySignal)) {
                *result = 1;
                return;
            }
...
// SIGNAL 0
void HelpWidget::mySignal()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void HelpWidget::mySignal(int _t1, QString _t2)
{
