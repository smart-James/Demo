    ...
    : QWidget(parent)
{
    ...
    m_pMinimizeButton->setIcon(QIcon("../Icons/jian.png"));
    m_pMinimizeButton->setFlat(true);
    //--
    m_pMaximizeButton->setIconSize(QSize(27,22));
    m_pMaximizeButton->setIcon(QIcon("../Icons/zhankai.png"));
    m_pMaximizeButton->setFlat(true);
    //--
    m_pCloseButton->setIconSize(QSize(27,22));
    m_pCloseButton->setIcon(QIcon("../Icons/jianqu.png"));
...
void titleBar::mouseDoubleClickEvent(QMouseEvent *event)
{
    ...
    emit m_pMinimizeButton->clicked();
}
...
void titleBar::onClicked()
{
    ...
    if (pWindow->isTopLevel())
    {
        ...
        {
            pWindow->isMaximized() ? pWindow->showNormal() : pWindow->showNormal();  //窗口最大化/还原显示
        }
